...
const Modal = ({ isOpen, onClose, title, children, size = '7xl' }: ModeProps) => {
    ...
    return (
        <>
            ...
            >
                <div className="ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex flex-col justify-center items-center ">
